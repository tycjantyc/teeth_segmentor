...
class Embeddings(nn.Module):
    def __init__(self,
        ...
        self.multi_init = [nn.Conv3d(in_channels=1, out_channels=8, kernel_size=3, stride=1, padding=1) for i in range(4)]
        
        self.multi_next = [MedNeXtBlock(
                in_channels=8,
                out_channels=8,
                exp_r=4,
                kernel_size=3,
    ...
    def forward(self, i1, i2, i3, i4):
        ...
        i1 = self.multi_next[0](self.multi_init[0](i1))
        i2 = self.multi_next[1](self.multi_init[1](i2))
        i3 = self.multi_next[2](self.multi_init[2](i3))
        i4 = self.multi_next[3](self.multi_init[3](i4))

        x = torch.cat((i1, i2, i3, i4), dim=1)
